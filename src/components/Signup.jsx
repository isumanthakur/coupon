...
import morningImage from '../assets/signin1.png';
import nightImage from '../assets/signin5.png';
import noonImage from '../assets/signin2.png';
import afternoonImage from '../assets/signin3.png';
import eveningImage from '../assets/signin4.png';
...
function Signup() {
    ...
    return (
        ...
        >
            ...
            {/* Right Side */}
            <motion.div 
                className={`flex flex-col h-1/2 md:h-screen justify-between mt-32 md:mt-0 p-8 w-full md:w-1/2 ${getHighlightedContainerColors(theme)} rounded-t-3xl md:rounded-t-none md:rounded-l-3xl`}
                initial={{ x: 200 }}
                animate={{ x: 0 }}
                transition={{ duration: 1 }}
            >
